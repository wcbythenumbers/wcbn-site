    ...
    return (
      ...
      <div className={styles.content}>
        ...
        <section className={styles.disclaimerBox}>
          <h2 className={styles.disclaimerHeading}>Disclaimer</h2>
            <p>West Chester by the Numbers is a publication of West Chester By the Numbers LLC. All content is provided for informational purposes only and does not constitute legal, financial, investment, or professional advice of any kind.</p>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerInner}>
          <span>© 2025 West Chester By the Numbers LLC</span>
